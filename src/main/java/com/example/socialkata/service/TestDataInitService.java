...
import com.example.socialkata.service.impl.ActiveServiceImpl;
import com.example.socialkata.service.impl.RoleServiceImpl;
import com.example.socialkata.service.impl.UserServiceImpl;
...
public class TestDataInitService {
    ...
    @Autowired
    public TestDataInitService(UserServiceImpl userService, RoleServiceImpl roleService, ActiveServiceImpl activeService) {
    ...
    public void setUsersWithRandomParameters() {
        ...
        String[] firstNames = new String[] {"Pep", "Jon", "Edd", "Cercei", "Jamie", "Karl", "Son", "Smith",
        ...
        String[] lastNames = new String[] {"Flow", "Snow", "Sand", "Wind", "Winter", "Kastark", "Sow", "White",
                "Walker", "Anderson", "Jackson", "Willie", "Stones", "Doche", "Dickens", "Lowe", "Locke", "Crown",
        ...
        String[] educations = new String[] {"Master degree", "High School", "Ph.D", "Highgarden", "Stanford University",
                "NNTU, Russia", "Oxford, United Kingdom", "Harvard, United States", "Home, Homeland",
        ...
        String[] cities = new String[] {"Москва", "Pavlovo", "Gorky", "Budapest", "London",
        ...
        String[] emails = new String[] {"admin@gmail.com", "eety@gmail.com", "fett@gmail.com", "nbnb@gmail.com",
                "d4444@gmail.com", "dsx@gmail.com", "zz5@gmail.com", "dbvnnd@gmail.com", "cxt@gmail.com",
        ...
        String[] passwords = new String[] {"$2a$12$A867XENvl1mrVozAvFawuup0Rt.xN5Ny5dmWOSyuJU4h9Syd2DuqW",
                "$2a$12$.LNZWaMp891irkJw6V7AZehdVOVWzJrXm4qfnDMstawpAgXULV8n."};

        String[] statuses = new String[] {"Chill", "relax", "Bored", "Lazy", "breathing", "zzzZzz...", "O_O", ":)",
                ")))", "??", "Walking", "busy", "InLov3", "3321", "Chill", "Отдихаю", "counting", "standing", "Дышу",
                "zzzZzz...", "O_O", ":)", ")))", "??", "Walking", "busy", "InLov3", "3321",
        ...
        String[] professions = new String[] {"Lirik", "Повар", "Craftmen", "Driver",
